...
elif os.path.exists("default_data.csv"):
    df_raw = pd.read_csv("default_data.csv")
    data_source_label = "Default Sample Dataset (default_data.csv)"
...
if df_raw is not None:
    ...
    # If no file is uploaded and default_data.csv is missing
    st.info(
        "Please upload a CSV file above, or save a file named 'default_data.csv' in the project folder to auto-load sample data."
    )